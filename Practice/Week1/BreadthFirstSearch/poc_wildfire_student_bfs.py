...
from CourseraPoc2.util import poc_queue, poc_grid
from CourseraPoc2.Practice.Week1.BreadthFirstSearch import poc_wildfire_gui_bfs
...
poc_wildfire_gui_bfs.run_gui(WildFire(30, 40))
