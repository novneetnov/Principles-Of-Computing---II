...
from CourseraPoc2.util import poc_grid, poc_stack
from CourseraPoc2.Practice.Week1.DepthFirstSearch import poc_wildfire_gui_dfs
...
poc_wildfire_gui_dfs.run_gui(WildFire(30, 40))
